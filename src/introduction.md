<section class="rs-hero">
  ...
  <div class="rs-hero__ctas">
    <a class="rs-btn rs-btn--primary" href="day-01-getting-started.html">Start Day 1 →</a>
    <a class="rs-btn rs-btn--ghost" href="https://github.com/praptisharma28/the-rust-book-simplified" target="_blank" rel="noopener">View on GitHub</a>
  </div>
</section>

<div class="rs-progress" role="group" aria-label="Book progress">
  <div class="rs-progress__label">
    <span>Progress</span>
...
<div class="rs-chapter-grid">

  <a class="rs-chapter-card" href="day-01-getting-started.html">
    <div class="rs-chapter-card__head">
      <span class="rs-chapter-card__day">Day 01</span>
      <span class="rs-chapter-card__ch">Ch. 1</span>
    </div>
    <div class="rs-chapter-card__title">Getting Started</div>
    <p class="rs-chapter-card__desc">Install Rust, cargo, and write your first program.</p>
  </a>

  <a class="rs-chapter-card" href="day-02-guessing-game.html">
    <div class="rs-chapter-card__head">
      <span class="rs-chapter-card__day">Day 02</span>
  ...
  <a class="rs-chapter-card" href="day-03-common-concepts.html">
    <div class="rs-chapter-card__head">
      <span class="rs-chapter-card__day">Day 03</span>
      <span class="rs-chapter-card__ch">Ch. 3</span>
    </div>
    <div class="rs-chapter-card__title">Common Concepts</div>
...
<h2 class="rs-section-title">Coming soon</h2>

<div class="rs-chapter-grid">

  <div class="rs-chapter-card rs-chapter-card--soon">
    <div class="rs-chapter-card__head">
      <span class="rs-chapter-card__day">Day 12</span>
      <span class="rs-chapter-card__ch">Ch. 12</span>
    </div>
    <div class="rs-chapter-card__title">I/O Project</div>
    <p class="rs-chapter-card__desc">A small CLI that ties everything together.</p>
  </div>

  <div class="rs-chapter-card rs-chapter-card--soon">
    <div class="rs-chapter-card__head">
      <span class="rs-chapter-card__day">Day 13</span>
...
Spotted a typo, or want to help ship Day 12 and beyond? PRs and issues welcome
on [GitHub](https://github.com/praptisharma28/the-rust-book-simplified).
